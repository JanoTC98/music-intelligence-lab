"""Multiclass (dominant genre) evaluation metrics (AGENTS.md §17.4, §17.5).
...
def evaluate_multiclass(
    ...
    """Compute the §17.4 metric set for one evaluation run.
...
def dominant_genre_exploratory(
    ...
    *,
    ...
    """Exploratory evaluation on multi-genre rows (§17.5).
