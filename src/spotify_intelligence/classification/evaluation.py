"""Multilabel evaluation metrics and experiment manifests (AGENTS.md §16.9).

Scores are uncalibrated; every metric name and report explicitly avoids the
word "probability" unless calibration is proven (§16.10).
"""
...
def evaluate_multilabel(
    ...
    """Compute the §16.9 metric set for one evaluation run.
...
def build_experiment_manifest(
    *,
    ...
    """Return a §24.4 experiment manifest."""
