...
The notebook demonstrates the preference recommender: preset
...
**Objetivo:** validar presets editables, distancia ponderada, detección
de perfiles fuera de distribución y diversidad MMR opcional.
...
Los presets viven en `configs/presets.yaml` y son editables
...
Se valida que un perfil con todos los pesos en cero es rechazado."""
        )
    )
    cells.append(
        code(
...
percentiles p95/p99 precomputados."""
        )
    )
    cells.append(
        code(
