...
**Método:** comprobación de la regla §9.4 de AGENTS.md: mayor `popularity_median`
...
gusto (§24 y §30 de AGENTS.md). Un par puede ser muy similar acústicamente y ser
